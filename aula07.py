...
def RL():
    ...
    def fazRL(x,y):
        ...
        #executa regressão considerando uma variável por vez 
        #primeiramente X0, depois X1....todas com y
...
def PCA_LDA():
    ...
    #chama PCA e reduz para 2 componentes
    pca = PCA(n_components=2)
    X_r = pca.fit(X).transform(X)
    #print('PCA Score:', pca.score(X,y))
    
    #chama LDA e reduz para 2 componentes
